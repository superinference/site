            ...
            {mainNavLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`block text-sm hover:text-neutral-900 dark:hover:text-white py-2 transition-colors ${active ? "text-neutral-900 dark:text-white font-medium underline underline-offset-4" : "text-neutral-600 dark:text-neutral-400"}`}
