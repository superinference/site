    ...
    <section id="asdlc-overview" className="scroll-mt-20 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        <div className="space-y-5 text-base/7 text-neutral-700 dark:text-neutral-300">
          ...
          <p><strong>AMI&apos;s Approach.</strong> SuperInference frames agent reasoning as feedback-driven inference with measurable information gain. AMI (Agentic Multi-step Inference) is the implementation: the multi-platform coding agent grounded in a partially observable decision process (POMDP) with 45+ tools, multi-provider cost optimization, and containerized execution. Instead of guessing when to stop, AMI tracks a mathematical belief state and uses information-theoretic criteria to know when further reasoning is unproductive.</p>
        </div>
        <div>
