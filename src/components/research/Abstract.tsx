  ...
  return (
    <section id="abstract" className="scroll-mt-20">
      ...
      <div className="w-full text-neutral-700 dark:text-neutral-300 text-base/7 space-y-3">
        ...
        <p>To assess SuperInference, we introduce metrics for semantic fidelity, calibration, and behavioral stability, applied to the DABStep framework. Across algorithmic reasoning, code debugging, and multi-step problem solving, SuperInference raises Gemini 2.5 Pro performance from 12.7% to 41.3%. Resources are available under open-source licenses through the project website and <a href="https://github.com/superinference" target="_blank" rel="noreferrer" className="underline hover:no-underline">GitHub organization</a>.</p>
      </div>
    </section>
  );
}
