...
export default function Retrieval() {
  return (
    <section id="retrieval" className="scroll-mt-20">
      <h2 className="text-2xl font-semibold tracking-tight text-neutral-900 dark:text-white mb-4 pb-2 border-b border-neutral-200 dark:border-neutral-800">Noisy Retrieval and Critic Gating</h2>
