    ...
    <section id="asdlc-engine" className="scroll-mt-20 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mt-10">
        <div className="space-y-5 text-base/7 text-neutral-700 dark:text-neutral-300">
          ...
          <p>For the full mathematical formalization, see the <a href="/research/#pre-loop" className="underline hover:no-underline">PRE Loop</a> and <a href="/research/#results" className="underline hover:no-underline">Formal Results</a> sections of the research paper.</p>
        </div>
        <div>
