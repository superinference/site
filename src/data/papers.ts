export const papers = [
  {
    ...
    doi: "",
    summary:
      "The open-source software framework for iterative LLM reasoning with critic-gated memory and information-theoretic stopping criteria, available as a VS Code extension and CLI, with an OpenClaw plugin in development.",
  ...
  },
  {
    ...
    doi: "",
    summary:
      "The agentic coding system combining multi-step inference, tool-augmented reasoning, and iterative self-correction to autonomously resolve real-world software engineering tasks, achieving state-of-the-art results on SWE-bench-Live.",
    authors: "Carlos Camacho-González and Cristina Catalán-Torrecilla and Luis Llana and Alberto Núñez and Luis Tomás",
    year: "2026",
    eprint: "2507.XXXXX",
    archivePrefix: "arXiv",
