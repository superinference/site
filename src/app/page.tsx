...
export default function Home() {
  return (
    <PageLayout title="AMI" subtitle="An AI coding agent built on the SuperInference framework. Model-agnostic. Sovereign. Free." toc={homeToc} titleClassName="text-5xl sm:text-6xl font-bold tracking-tight text-neutral-900 dark:text-white">
        ...
        <div className="mt-8 space-y-10">
          <div id="sovereign-cloud" className="scroll-mt-20">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                { title: "Apache 2.0, EU-funded", desc: "Distributed under the Apache 2.0 license. The SuperInference framework is fully open source. Funded by the European Union&apos;s Horizon Europe programme and the Spanish Ministry of Science." },
              ].map((f) => (
                <div key={f.title} className="rounded-xl border border-neutral-200 dark:border-white/10 p-5">
                  <div className="text-sm font-semibold text-neutral-900 dark:text-white mb-1">{f.title}</div>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">{f.desc}</p>
          ...
          <div id="sovereign-agents" className="scroll-mt-20">
            ...
            <div className="space-y-4 text-neutral-700 dark:text-neutral-300 text-base/7">
              ...
              <p>AMI breaks this dependency chain. The agent is distributed under Apache 2.0, built on the open-source SuperInference framework. The model is your choice — from frontier APIs to fully local inference. The deployment is your infrastructure — a laptop, a private cloud, or an air-gapped data center. FRITO eliminates cost as a barrier by routing through free-tier providers. The result is an AI coding agent that is genuinely yours: sovereign in code, sovereign in compute, sovereign in data.</p>
            </div>
          </div>
        </div>
      </div>
