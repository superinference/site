  ...
  return (
    ...
    >
      ...
      <div id="ami" className="scroll-mt-20">
        ...
        {/* SWE Bench Live Java */}
          <div id="swebench-live-java" className="scroll-mt-20">
            <h3 className="text-xl font-semibold tracking-tight text-neutral-900 dark:text-white mb-4 pb-2 border-b border-neutral-200 dark:border-neutral-800">SWE Bench Live Java</h3>
            <p className="mt-1 text-xs text-neutral-400 dark:text-neutral-500">August 2026</p>

            <div className="mt-4 space-y-4 text-neutral-700 dark:text-neutral-300">
              <p>
                The Java subset of SWE-bench Live evaluates agents on 109 real-world Java issues —
                testing build system navigation, dependency management, and idiomatic fixes across
                complex enterprise-scale codebases with deep class hierarchies and verbose APIs.
              </p>
            </div>
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-xl border border-neutral-200 dark:border-white/10 bg-neutral-50 dark:bg-neutral-900/60 p-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                  ...
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl font-bold text-blue-600 dark:text-blue-400">67.0%</div>
                    <div className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Resolved</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl font-bold text-blue-600 dark:text-blue-400">73</div>
                    <div className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Problems Solved</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl sm:text-4xl font-bold text-blue-600 dark:text-blue-400">1.43&times;</div>
                    <div className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">More Solved vs 2nd</div>
                  </div>
                </div>
                ...
                <div className="border-t border-neutral-200 dark:border-neutral-700 pt-4 space-y-3">
                  <p className="text-sm text-neutral-700 dark:text-neutral-300">
                    <span className="font-semibold">AMI Agent + Claude-4.6-Opus</span> solved <span className="font-semibold text-blue-600 dark:text-blue-400">73 out of 109</span> Java
                    issues (67.0%), securing first place. The runner-up (SWE-agent + GPT-5.5) solved 51 out of 102 (50.0%) — AMI
                    solved <span className="font-semibold text-blue-600 dark:text-blue-400">1.43&times; more problems</span> while
                    also evaluating on a larger test set.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-neutral-200 dark:border-white/10 overflow-hidden">
                <Image
                  src="/leaderboards/swebench_live_java.png"
                  alt="SWE Bench Live Java Leaderboard showing AMI Agent + Claude-4.6-Opus at #1 with 67.0%"
                  width={1200}
                  height={800}
                  className="w-full h-auto"
                  priority
              ...
              <div className="text-xs text-neutral-500 dark:text-neutral-400 text-center">
                Source: <a href="https://swe-bench-live.github.io/#leaderboard-java" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">swe-bench-live.github.io</a>. August 2026.
              </div>
            </div>
          </div>
